...
function Clock(): ReactElement {
  ...
  return (
    <div
      className="text-sans relative group w-[300px] h-[136px] bg-gradient-to-t from-[#34373c] to-[#f2f2f2] rounded-xl text-black flex justify-center flex-col transition-all duration-300 overflow-hidden"
